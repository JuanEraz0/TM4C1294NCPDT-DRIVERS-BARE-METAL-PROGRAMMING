...
void gpio_init_portJ(void){
    ...
    GPIO_PORTJ_AHB_DIR_R = 0x00; //Set PJ0 & PJ1 as input
    GPIO_PORTJ_AHB_PUR_R = 0x03; //Enables PJ0 & PJ1 Pull-Up Resistances
    GPIO_PORTJ_AHB_DEN_R = 0x03; //Set up PJ0 & PJ1 as digital pins
